...
let antiCallMessage = process.env.ANTICALL_MESSAGE ||  "\`\`\`Hii this is Jace-Xky a Personal Assistant!!\n\n\tSorry for now, i can't receive calls, whether in a group or personal case \n\n if you need me please waiting for a moment \n\n\nI will be here ASAP🙏🏽\`\`\`" ;
